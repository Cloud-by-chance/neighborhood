...
ENTRYPOINT ["java","-javaagent:apm-agent.jar", "-Delastic.apm.service_name=NUVI-release -Delastic.apm.environment=dev -Delastic.apm.application_Packages=com.example.nuvi_demo -Delastic.apm.server_ursl=http://k8s-es-apmingre-6b3e599b30-1594117206.ap-northeast-2.elb.amazonaws.com","-jar", "app.jar"]

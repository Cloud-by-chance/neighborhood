...
CMD ["java","-javaagent:apm-agent.jar", "-Delastic.apm.service_name=NUVI-release  -Delastic.apm.environment=production -Delastic.apm.application_Packages=NuviDemoApplication.java -Delastic.apm.server_urls=k8s-es-apmingre-6b3e599b30-1594117206.ap-northeast-2.elb.amazonaws.com","-jar", "app.jar"]
